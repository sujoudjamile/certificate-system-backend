...
export default function Staff() {
  ...
  name: "", student_id: "", email: "",phone: "",dob: "",national_id: "",degree: "Bachelor"   
});
  ...
  try {
    const res = await axios.post(
      "http://localhost:5000/api/students/", // change path
      {
        ...
        degree: studentForm.degree   // ✅ ADD THIS
      },
      {
        headers: {
    ...
    setStudents([
      ...students,
      {
        ...
        full_name: studentForm.name,
        email: studentForm.email,
        phone: studentForm.phone,     // ✅ ADD
        national_id: studentForm.national_id,
        date_of_birth: studentForm.dob,
        degree: studentForm.degree    // ✅ ADD
      }
    ]);
      ...
      {showStudentModal && (
        <div className="modal">
          <div className="modal-box">
            ...
            <input placeholder="Student_ID" onChange={e => setStudentForm({ ...studentForm, student_id: e.target.value })}/>
            ...
            <select onChange={e => setStudentForm({...studentForm, degree: e.target.value})}>
